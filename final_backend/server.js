...
//admin
const adminbookings = require('./adminroutes/adminBookings');
const adminincomingrequest = require('./adminroutes/adminincomingrequest');
const adminnotifications = require('./adminroutes/adminnotifications');
const admintasker = require('./adminroutes/admintasker');
const admintaskercancel = require('./adminroutes/admintaskercancel');
const admintaskerconfirm = require('./adminroutes/admintaskerconfirm');
const admintaskerincompleted = require('./adminroutes/admintaskerincompleted');
const admintaskerPending = require('./adminroutes/admintaskerPending');
const admintasks = require('./adminroutes/admintasks');
const adminuser = require('./adminroutes/adminuser');
const adminusercancel = require('./adminroutes/adminusercancel');
const adminuserconfirm = require('./adminroutes/adminuserconfirm');
...
app.use('/adminincomingrequest', adminincomingrequest);
app.use('/adminnotifications', adminnotifications);
app.use('/admintasker', admintasker);
app.use('/admintaskercancel', admintaskercancel);
app.use('/admintaskerconfirm', admintaskerconfirm);
app.use('/admintaskerincompleted', admintaskerincompleted);
app.use('/admintaskerPending', admintaskerPending);
app.use('/admintasks', admintasks);
app.use('/adminuser', adminuser);
app.use('/adminusercancel', adminusercancel);
app.use('/adminuserconfirm', adminuserconfirm);
app.use('/adminuserincompleted', adminuserincompleted);
